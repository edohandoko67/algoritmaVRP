...
class DatabaseActivityOfficer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_database_officer)
        ...
        rute = FirebaseDatabase.getInstance().getReference("db2")
        ...
        rute.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    val adapter = UserAdapter2(routeList, this@DatabaseActivityOfficer)
